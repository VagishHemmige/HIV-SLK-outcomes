...
knitr::opts_knit$set(root.dir = "/Users/hannahrosenthal/Library/CloudStorage/OneDrive-MontefioreMedicine/Clara Tow's files - HIV SLK Study/R analysis/SRTR data/March 2023")
```
...
Use Dr. Hemmige's package for automatic variable labeling and factor conversion using the official SRTR data dictionary.
```{r}
devtools::install_github("VagishHemmige/sRtr", force=TRUE)
library(sRtr)
set_srtr_wd("/Users/hannahrosenthal/Library/CloudStorage/OneDrive-MontefioreMedicine/Clara Tow's files - HIV SLK Study/R analysis/SRTR data/March 2023")
```


Install Dr. Hemmige's package for strobe package to track participants added in and out of the cohort 
```{r}
# install.packages("devtools")
devtools::install_github("VagishHemmige/strobe", force=TRUE) 
