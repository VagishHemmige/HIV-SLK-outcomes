...
-   [`R/figures.R`](https://github.com/VagishHemmige/Cryptococcus-cost-analysis/blob/master/R/Figures.R)

This R script file is itself reliant on the following helper files:

-   [`R/setup.R`](https://github.com/VagishHemmige/Cryptococcus-cost-analysis/blob/master/R/setup.R)
-   [`R/functions.R`](https://github.com/VagishHemmige/Cryptococcus-cost-analysis/blob/master/R/functions.R)
:::
